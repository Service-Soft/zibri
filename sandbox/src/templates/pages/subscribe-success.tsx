import { MailingListSubscribeSuccessPageTemplate, MaskUtilities } from 'zibri';
...
export const SubscribeSuccessPage: MailingListSubscribeSuccessPageTemplate = ({
    ...
    return (
        <EmptyPage title='Subscribed successfully'>
            <Card className='text-center flex flex-col gap-6'>
                ...
                <p>
                    You can manage your preferences <a href={managePreferencesLink}>here</a>
                </p>
            </Card>
        </EmptyPage>
    );
